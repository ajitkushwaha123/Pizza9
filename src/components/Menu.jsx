  ...
  return (
    <div className='w-full'>
       <div className='bg-[#EDF000] md:pt-[40px] md:px-[100px] px-[30px]'>
        ...
        <div className='bg-white bg-pattern1 py-[50px] flex md:flex-row flex-col justify-center items-center'>
           <div className='md:w-[50%] bg-pattern2 w-[100%]'>
              ...
              <div className='flex bg-pattern2 w-[100%] px-[40px] items-center justify-between md:pl-[40px] py-[30px] md:pr-[80px]'>
                <img className='w-[140px]' src='http://www.mbachaiwala.com/wp-content/uploads/2023/04/Zomato_button-jpg.webp'/>
